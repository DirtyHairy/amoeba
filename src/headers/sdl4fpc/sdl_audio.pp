...
{$PACKRECORDS 4}
 ...
 { Pointers to basic pascal types, inserted by h2pas conversion program.}
  ...
  function SDL_OpenAudio(desired:pSDL_AudioSpec; var obtained:SDL_AudioSpec):longint;cdecl;
  ...
  function SDL_OpenAudio(desired:pSDL_AudioSpec; var obtained:SDL_AudioSpec):longint;cdecl;external 'SDL';
